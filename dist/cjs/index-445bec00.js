    ...
    if (BUILD.style && Cstr && Cstr.style) {
      ...
      if (!styles.has(scopeId2)) {
        ...
        BUILD.shadowDomShim && cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
          style = await Promise.resolve().then(function () { return require('./shadow-css-65ab8b60.js'); }).then((m) => m.scopeCss(style, scopeId2, false));
        }
...
//# sourceMappingURL=index-445bec00.js.map