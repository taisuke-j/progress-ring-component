...
const ProgressRing$1 = /*@__PURE__*/ proxyCustomElement(class ProgressRing extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return progressRingCss; }
        ...
        "intSize": [2, "int-size"],
        "decimalSize": [2, "decimal-size"],
        "disableDigits": [4, "disable-digits"],
        "disableDecimals": [4, "disable-decimals"],
        "roundLinecap": [4, "round-linecap"],
        "colors": [1],
        "invertColors": [4, "invert-colors"],
        "percentage": [1538],
        "duration": [2],
        "easingType": [1, "easing-type"],
        "eventId": [1, "event-id"]
    }, undefined, {
        "radius": ["radiusUpdated"],
        "strokeWidth": ["strokeWidthUpdated"],
    ...
    components.forEach(tagName => { switch (tagName) {
        case "progress-ring":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ProgressRing$1);
            }
            break;
    } });
}

const ProgressRing = ProgressRing$1;
const defineCustomElement = defineCustomElement$1;

export { ProgressRing, defineCustomElement };
